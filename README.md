...
# Batches
![code quality score](https://api.codiga.io/project/30163/score/svg) 
![code Grade](https://api.codiga.io/project/30163/status/svg) 

## Details of contributer

SF ID. |  Name   |    Features    |  Issuess Raised |     Issues Resolved
-------|---------|----------------|----------------|---------------|
`40020670` | Nittala saranya  | Passenger-controlled seat heater   |  NA    |  NA   
